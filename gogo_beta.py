...
#####################################  MOVE XARM  #####################################
        ...
        final_pose = [-318.34845, 476.89444, 395.504242, 1.614076, -0.791094, -1.838659] # attention
        self.arm.set_position(x=final_pose[0], y=final_pose[1], z=final_pose[2], roll=[3], pitch=[4], yaw=[5],
